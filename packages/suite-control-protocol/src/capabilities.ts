...
export const CAPABILITIES: Record<string, RoleCapability> = {
  ...
  player: {
    ...
    port: 8725,
    actions: [
      { id: 'cue', label: 'Cue auslösen', verb: 'cue', args: [{ id: 'n', label: 'Cue (Nr.)', type: 'number', default: 1, min: 1, max: 99 }] },
      { id: 'play', label: 'Play', verb: 'play' },
      { id: 'pause', label: 'Pause', verb: 'pause' },
      { id: 'stop', label: 'Stopp', verb: 'stop' },
      { id: 'next', label: 'Nächster Titel', verb: 'next' },
      { id: 'prev', label: 'Vorheriger Titel', verb: 'prev' },
      { id: 'vol', label: 'Lautstärke (0–100)', verb: 'vol', args: [{ id: 'level', label: 'Pegel', type: 'number', default: 100, min: 0, max: 100 }] },
    ],
    variables: [
      { id: 'state', label: 'Status (playing/paused/stopped)' },
      { id: 'cue', label: 'Aktive Cue (Nr.)' },
      { id: 'clip_name', label: 'Titel' },
      { id: 'position', label: 'Position' },
    ],
    feedbacks: [
      { id: 'playing', label: 'Player spielt', stateKey: 'state', match: 'truthy', bgcolor: GREEN, color: WHITE },
      { id: 'cue_active', label: 'Cue ist aktiv', stateKey: 'cue', match: 'equalsArg', arg: { id: 'n', label: 'Cue (Nr.)', type: 'number', default: 1, min: 1, max: 99 }, bgcolor: GREEN, color: WHITE },
    ],
  },
