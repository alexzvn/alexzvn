...
/**
 * Startet den utilityProcess mit dem nativen NDI-Sender (Muster aus
 * apps/titler/src/main/ndi/sender-process.ts).
 *
...
export function startSender(
  ...
  win.webContents.postMessage('jmcaption:frame-port', null, [port1]);
}
