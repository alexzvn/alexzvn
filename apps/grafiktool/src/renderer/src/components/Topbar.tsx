...
const NAV: NavItem[] = [
  { id: 'editor', label: 'Editor', hint: 'Ebenen · Werkzeuge · Export' },
  { id: 'bibliothek', label: 'Bibliothek', hint: 'Vorlagen · Grafiken' },
];

interface Props {
  section: Section;
  onSection: (section: Section) => void;
  /** Optional contextual content rendered between the nav and the theme toggle. */
  children?: React.ReactNode;
}

export function Topbar({ section, onSection, children }: Props) {
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex flex-col leading-tight">
            <span className="text-sm font-extrabold tracking-[0.06em]">JM GRAFIK</span>
