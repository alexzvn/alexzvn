...
const NAV: NavItem[] = [
  { id: 'video', label: 'Video', hint: 'Codec · Auflösung · Preset' },
  { id: 'office', label: 'Dokumente', hint: 'Office → PDF' },
];
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex flex-col leading-tight">
            <span className="text-sm font-extrabold tracking-[0.06em]">JM CONVERT</span>
