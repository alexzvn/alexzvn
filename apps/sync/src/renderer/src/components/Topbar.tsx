...
const NAV: NavItem[] = [
  { id: 'measure', label: 'Messung', hint: 'Versatz in ms' },
  { id: 'generator', label: 'Generator', hint: 'Blitz + Piep' },
  { id: 'calibrate', label: 'Kalibrierung', hint: 'Null-Abgleich' },
];
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex flex-col leading-tight">
            <span className="text-sm font-extrabold tracking-[0.06em]">JM SYNC</span>
            <span className="text-[10px] uppercase tracking-[0.14em] text-[var(--muted-foreground)]">
              A/V Delay {runtime === 'web' ? '· Mobile' : ''}
            </span>
          </div>
        </div>
